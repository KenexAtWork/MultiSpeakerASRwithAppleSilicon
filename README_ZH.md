...
詳細使用說明請參考 [GUI 使用說明](gui/README_ZH.md)。
...
詳細說明請參考 [examples/README_ZH.md](examples/README_ZH.md)
...
詳細測試說明請參考 [tests/README_ZH.md](tests/README_ZH.md)
...
├── README_ZH.md                 # 中文版 README（本檔案）
├── COMPARISON.md                # 與 WhisperX 的比較（英文）
├── COMPARISON_ZH.md             # 與 WhisperX 的比較（中文）
└── LICENSE                      # MIT 授權
```
...
詳細比較請參考 [COMPARISON_ZH.md](COMPARISON_ZH.md)
